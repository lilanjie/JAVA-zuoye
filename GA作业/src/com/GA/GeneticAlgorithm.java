...
public abstract class GeneticAlgorithm {
    ...
    public void caculte() {
        ...
        bestTotalScore = 0;
        init();
        while (bestTotalScore<750/*generation < maxIterNum*/) {
            //种群遗传
            evolve();
    ...
    private void print() {
        ...
        System.out.println("the best total fitness is:" + bestTotalScore);
    }
    ...
    private void caculteScore() {
        ...
        worstScore = 30;//population.get(0).getScore();
        totalScore = 0;
        for (Chromosome chro : population) {
